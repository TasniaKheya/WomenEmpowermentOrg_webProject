...
if (strlen($_SESSION['avmsaid']==0)) {
    ...
    $query=mysqli_query($con,"INSERT into tasks(task_name,task_details) value ('$task_name','$task_details')");
      ...
      <?php if($msg){ echo "<div class='alert alert-success alert-dismissible'>
        ...
        <div class="box box-default">
          ...
          <!-- /.box-header -->
              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="task_details" required>
                  </div>
                  <!-- /.form-group -->
                </div>
            ...
            <button type="submit" class="btn btn-block btn-primary btn-lg" name="submit">Insert Task Details</button>
            </div>
          </div>
          </form>
