...
if (strlen($_SESSION['avmsaid']==0)) {
    ...
    $provided_money=$_POST['provided_money'];
    $ret1=mysqli_query($con,"SELECT * from  craft_buyer where  buyer_id= $buyer_id");
    $resultCheck2 = mysqli_num_rows($ret1);
    if($resultCheck2==0)
    $query=mysqli_query($con,"INSERT into craft_buyer value ('$buyer_name','$buyer_id','$provided_money')");
              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="buyer_id" required>
                  </div>
                  <div class="form-group">
                    <label>provided_money</label>
                    <input type="text" class="form-control" name="provided_money" required>
                  </div>
                  <!-- /.form-group -->
                </div>
