...
if (strlen($_SESSION['avmsaid']==0)) {
    ...
    $query=mysqli_query($con,"INSERT into trainee(traineeId,traineeName,Tphoneno,provided_fee) value ('$traineeId','$traineeName','$Tphoneno','$provided_fee')");
