...
if (strlen($_SESSION['avmsaid']==0)) {
      ...
      if(isset($_POST['submit']))
    {
        ...
        $eduFee =$_POST['eduFee'];
    $ret1=mysqli_query($con,"SELECT * from WomenStudent where  WomenStudent. studentId= $studentId");
    $resultCheck2 = mysqli_num_rows($ret1);
    if($resultCheck2==0)
    $query=mysqli_query($con,"INSERT into WomenStudent value ('$studentId','$studentName','$eduFee')");
...
<div class="wrapper">
    ...
    <?php $page='traine'; include 'includes/sidebar3.php'?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="dashboard3php"><i class="fa fa-dashboard"></i> Home</a></li>
          ...
          <!-- /.box-header -->
            ...
            <div class="box-body">
              <div class="row">
                ...
                <div class="form-group">
                    <label>eduFee</label>
                    <input type="text" class="form-control" name="eduFee" required>
                  </div>
                  <!-- /.form-group -->
                </div>
